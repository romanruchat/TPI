                ...
                <form action="?action=UpdateDish" method="post">
                    <div class="form-group">
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <div class="form-label-group">
                                    <input type="number" id="dishPrize" name="dishPrize" class="form-control" value="<?= $data['Prize']; ?>" required="required">
                    ...
                    <div class="form-group">
                        <div class="form-label-group">
                            <input type="file" id="dishImages" name="dishImages" class="form-control" accept=".png, .jpeg" multiple />
