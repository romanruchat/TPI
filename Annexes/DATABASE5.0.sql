...
CREATE TABLE IF NOT EXISTS `reveries_db`.`Order` (
  ...
  PRIMARY KEY (`idOrder`),
  INDEX `fk_Order_User1_idx` (`User_idUsers` ASC),
...
CREATE TABLE IF NOT EXISTS `reveries_db`.`Images` (
  ...
  INDEX `fk_Images_Dishes1_idx` (`Dishes_idDishes` ASC) ,
...
CREATE TABLE IF NOT EXISTS `reveries_db`.`Order_has_Dishes` (
  ...
  INDEX `fk_Order_has_Dishes_Dishes1_idx` (`Dishes_idDishes` ASC),
  INDEX `fk_Order_has_Dishes_Order1_idx` (`Order_idOrder` ASC),
...
CREATE TABLE IF NOT EXISTS `reveries_db`.`User_has_Particularities` (
  ...
  INDEX `fk_User_has_Particularities_Particularities1_idx` (`Particularities_idParticularities` ASC),
  INDEX `fk_User_has_Particularities_User1_idx` (`User_idUsers` ASC),
...
-- -----------------------------------------------------
-- Table `reveries_db`.`Dishes_has_Particularities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `reveries_db`.`Dishes_has_Particularities` (
  `Particularities_idParticularities` INT NOT NULL,
  `Dishes_idDishes` INT NOT NULL,
  PRIMARY KEY (`Particularities_idParticularities`, `Dishes_idDishes`),
  INDEX `fk_Particularities_has_Dishes_Dishes1_idx` (`Dishes_idDishes` ASC),
  INDEX `fk_Particularities_has_Dishes_Particularities1_idx` (`Particularities_idParticularities` ASC),
